...
MIGRATION_MODULES = {"sites": "helpdesk.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "helpdesk.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Mike Farad""", "mike-farad@example.com")]
...
ACCOUNT_FORMS = {"signup": "helpdesk.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "helpdesk.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "helpdesk.users.forms.UserSocialSignupForm"}
